...
/staticcontent
    /css
        /source
            /mixins                         # Примеси. Каждая в своём файле
                ...
                _sprite.scss                # Переменные спрайта. генерируется автоматически
                ...
            ...
            /blocks                         # Блоки по БЭМу. Каждый в своей папке
                /block
                    _block.scss             # Стили блока
                    _block--modifier.scss   # Модификатор блока (подключается в файле блока)
                ...
    ...
    /img                                    # Изображения
        ...
        ...
    /vendor                                 # Сторонние библиотеки. Каждая в своей папке
        /normalize                          # Нормалайз
            normalize.scss
        ...
